            ...
            <form wire:submit.prevent="update" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea wire:model="body" rows="22"
                        class="w-full px-4 py-2 rounded-xl border-gray-200 focus:border-[var(--primary-color)] focus:ring-[var(--primary-color)] transition-all font-mono text-sm leading-relaxed"></textarea>
