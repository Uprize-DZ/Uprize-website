<section class="py-16 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 mb-10 text-center">
        <h3 class="text-sm font-semibold uppercase tracking-widest text-[#6b66ff]/60 mb-2">Trusted by Industry Leaders
        </h3>
        <div class="w-12 h-1 bg-[#6b66ff] mx-auto rounded-full"></div>
    </div>
