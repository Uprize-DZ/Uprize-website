        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">API</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Security</a></li>
                    <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Compliance</a></li>
                </ul>
            </div>
        </div>
